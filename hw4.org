#+TITLE:CSPP 53001: Assignment 4

*Online homework and project due by 11:59am on Thursday, May 9, 2013*
...
create a new directory called =hw3_<your_username>=,
e.g. =hw3_evtimov=, and move all of the relevant scripts and data
files there. Then, you can submit your work by typing (=<path_to>= is
the directory path to your =hw3= directory).
...
The name of the homework is CSPPDB-Spr13 HW4. There are 11 questions in
